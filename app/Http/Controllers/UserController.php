...
class UserController extends Controller
{
    ...
    {
        $account = User::where('role','>',0)->paginate(5);
        return view('admin.pages.account.listemploy',compact('account'));
    }
    ...
    {
        $account1 = User::where('role','=',0)->paginate(5);
        return view('admin.pages.account.listcus',compact('account1'));
    }
    ...
    public function loginAdmin(Request $request) {
        ...
        if(Auth::attempt($data,$request->has('remember'))){
            ...
            return redirect()->route('login.index')->with('error','Đăng nhập thất bại. Xin vui lòng kiểm tra lại tài khoản');
        }
    }
}
