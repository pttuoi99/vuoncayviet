				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<button class="btn btn-danger btn-circle deleteProduct"  data-toggle="modal" data-target="#delete" type="button" ><i class="fas fa-trash"></i></button>
						</td>
					</tr>
					@endforeach
				</tbody>
					...
					<div class="col-lg-12">
						<form role="form" id="updateProduct" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control name" name="name" value="">
							</div>
							<div class="form-group">
								<label>Cấp bậc</label>
								<select class="form-control status" name="status">
