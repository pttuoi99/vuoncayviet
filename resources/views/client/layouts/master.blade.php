...
<head>
    <title>Vườn Cây Việt | @yield('title')</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/client/images/logo.gif">
    <!-- Meta tag Keywords -->
    ...
    <!-- web fonts -->
    <link href="assets/client/css/nato.css" rel="stylesheet">
    <link href="assets/client/css/opensam.css" rel="stylesheet">
    <!-- //web fonts -->
...
<body>
    ...
    <!-- header-bottom-->
    @include('client.layouts.header-bot')
