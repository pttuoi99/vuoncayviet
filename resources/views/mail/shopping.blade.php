                            ...
                            <tbody>
                                <tr>
                                    <td align="left" valign="middle" style="width:500px;height:60px">
                                        <a href="https://www.facebook.com/Trung-T%C3%A2m-V%C6%B0%E1%BB%9Dn-C%C3%A2y-Vi%E1%BB%87t-108115753995420/" style="border:0" target="_blank" width="130" height="35" style="display:block;border:0px">
                                            <img src="https://scontent.fdad2-1.fna.fbcdn.net/v/t1.0-9/77070122_108116553995340_5949024824494915584_n.jpg?_nc_cat=101&_nc_ohc=EAqsR6bnfWEAQmaIh0nzVUuf5CyhgwXIvaR38Psr_LWpEN1x7znTrTDcA&_nc_ht=scontent.fdad2-1.fna&oh=71e9d7c949cdb82f7d34e964ad84f7d2&oe=5E3E4298" height="100" width="115" style="display:block;border:0px;float: left;"> <b style="float: left;line-height: 100px;color: green;font-size: 20px;">Vườn Cây Việt</b>
                                        </a>
                                    </td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="left" valign="middle" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;padding:0 10px 20px 10px;line-height:17px">
                                        Chào {{ $order->name }},
                                        <br> Cám ơn bạn đã mua sắm tại Vườn Cây Việt
                                        <br>
                            ...
                            <tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;line-height:20px;padding-left:10px;padding-bottom:5px"> 
                                                            ...
                                                            - <a href="tel:0919918817" style="color: blue">0919918817</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;line-height:20px;padding-bottom:5px">:</td>
                                                        <td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;line-height:20px;padding-left:10px;padding-bottom:5px">
                                                            @if($o['price']*$o['quantity'] > 300000)
                                                            {{number_format( $o['price']*$o['quantity']) }}đ
                                                            @else
                                                            {{ number_format(($o['price']*$o['quantity'])+20000 )}}đ
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    <tr>
                                ...
                                <tr>
                                    <td colspan="2" align="center" valign="top" style="padding-top:20px;padding-bottom:20px;border-bottom:1px solid #ebebeb">
                                        <a href="order" style="border:0px" target="_blank"> 
